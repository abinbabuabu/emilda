...
import com.emilda.emildaapp.Utils.BottomAppBarCutCornersTopEdge
...
fun getRupeesList():List<Int>{
   return listOf(50,100,130,150,200)
}

fun getCoinsList():List<Int>{
    return listOf(50,102,140,160,220)
}
